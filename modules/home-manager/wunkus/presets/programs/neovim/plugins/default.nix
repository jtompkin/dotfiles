...
let
  ...
  pluginConfigs = {
    ...
    cellular-automaton-nvim.config = # lua
      ''
    ...
    lualine-nvim.config = # lua
      ...
      '';
    mini-ai.config = appendNewline ''require("mini.ai").setup({})'';
    mini-clue.config = # lua
      ''
    ...
    nvim-lspconfig =
      ...
      in
      {
        # I think I do this to load after completion? Don't know if that matters
        order = 1001;
        config =
          useEmbeds
            # lua
    ...
    nvim-treesitter.config =
      let
        ...
        # TODO: Remove remove once nvim-treesitter is better
        langsLuaTable = "{ ${
      ...
      useEmbeds
        ...
        '';
    nvim-treesitter-context.config = appendNewline ''require("treesitter-context").setup({ max_lines = 3 })'';
    render-markdown-nvim.config = # lua
      ''
